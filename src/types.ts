...
export interface ChunkCitation { readonly sourceId: string; readonly sourcePath: string; readonly startLine: number; readonly endLine: number; readonly startOffset: number; readonly endOffset: number; readonly representation?: 'json'; readonly representationStartOffset?: number; readonly representationEndOffset?: number; }
